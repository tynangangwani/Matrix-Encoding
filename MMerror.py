...
if comm.rank == 0:
  ...
  encEnd=time.time()
  print("time spent encoding: ", (encEnd-encStart))
  ...
  print ("Time spent waiting for %d workers %s is: %f" % (N, ",".join(map(str, [x + 1 for x in lst])), (bp_received - bp_sent)))
  print(lst)
